...
#pragma warning restore 0618
        ...
        static void RenderSingleCamera(ScriptableRenderContext context, CameraData cameraData)
        {
            ...
            /*public static class Pipeline
            {
                ...
                const string k_Name = nameof(HybridRenderPipeline);
                ...
                {
                    const string k_Name = nameof(HybridRenderer);
                    public static readonly ProfilingSampler setupCullingParameters = new ProfilingSampler($"{k_Name}.{nameof(HybridRenderer.SetupCullingParameters)}");
                    public static readonly ProfilingSampler setup = new ProfilingSampler($"{k_Name}.{nameof(HybridRenderer.Setup)}");
                };
            ...
            public HybridRenderPipeline(HybridRenderPipelineAsset asset)
            {
    #if UNITY_EDITOR
            ...
            protected override void Dispose(bool disposing)
            {
                ...
                UnityEngine.Rendering.Universal.ShaderData.instance.Dispose();
    ...
    #pragma warning restore 0618
            ...
            static int GetMainLightIndex(HybridRenderPipelineAsset settings, NativeArray<VisibleLight> visibleLights)
            {
